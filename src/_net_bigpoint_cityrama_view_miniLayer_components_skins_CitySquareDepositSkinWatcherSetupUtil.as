package
{
   ...
   public class _net_bigpoint_cityrama_view_miniLayer_components_skins_CitySquareDepositSkinWatcherSetupUtil implements IWatcherSetupUtil2
   {
      
      public function _net_bigpoint_cityrama_view_miniLayer_components_skins_CitySquareDepositSkinWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         CitySquareDepositSkin.watcherSetupUtil = new _net_bigpoint_cityrama_view_miniLayer_components_skins_CitySquareDepositSkinWatcherSetupUtil();
      }
