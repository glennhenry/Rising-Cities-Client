package
{
   ...
   public class _net_bigpoint_cityrama_view_residentSelection_ui_skins_ResidentListSkinWatcherSetupUtil implements IWatcherSetupUtil2
   {
      
      public function _net_bigpoint_cityrama_view_residentSelection_ui_skins_ResidentListSkinWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         ResidentListSkin.watcherSetupUtil = new _net_bigpoint_cityrama_view_residentSelection_ui_skins_ResidentListSkinWatcherSetupUtil();
      }
