package
{
   ...
   public class _net_bigpoint_cityrama_view_friendBook_ui_components_FriendTabItemRendererWatcherSetupUtil implements IWatcherSetupUtil2
   {
      
      public function _net_bigpoint_cityrama_view_friendBook_ui_components_FriendTabItemRendererWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         FriendTabItemRenderer.watcherSetupUtil = new _net_bigpoint_cityrama_view_friendBook_ui_components_FriendTabItemRendererWatcherSetupUtil();
      }
