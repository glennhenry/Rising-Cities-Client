package
{
   ...
   import net.bigpoint.cityrama.view.mainMenu.ui.skins.QuadToggleButtonSkin;
   
   public class _net_bigpoint_cityrama_view_mainMenu_ui_skins_QuadToggleButtonSkinWatcherSetupUtil implements IWatcherSetupUtil2
   {
      
      public function _net_bigpoint_cityrama_view_mainMenu_ui_skins_QuadToggleButtonSkinWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         QuadToggleButtonSkin.watcherSetupUtil = new _net_bigpoint_cityrama_view_mainMenu_ui_skins_QuadToggleButtonSkinWatcherSetupUtil();
      }
