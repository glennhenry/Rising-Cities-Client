package
{
   ...
   public class _net_bigpoint_cityrama_view_rewardLayer_ui_skins_RewardLayerBigListSkinWatcherSetupUtil implements IWatcherSetupUtil2
   {
      
      public function _net_bigpoint_cityrama_view_rewardLayer_ui_skins_RewardLayerBigListSkinWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         RewardLayerBigListSkin.watcherSetupUtil = new _net_bigpoint_cityrama_view_rewardLayer_ui_skins_RewardLayerBigListSkinWatcherSetupUtil();
      }
