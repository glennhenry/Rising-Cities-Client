package as3isolib.data
{
   ...
   public class Node extends EventDispatcherProxy implements INode
   {
      ...
      {
         return this.setID == null || this.setID == "" ? "node" + this.UID.toString() : this.setID;
      }
      ...
      {
         return this.as3isolib_internal::parentNode ? true : false;
      }
      ...
      public function setChildIndex(param1:INode, param2:uint) : void
      {
         ...
         if(_loc3_ > -1)
         {
            ...
            for each(var _loc4_ in this.as3isolib_internal::childrenArray)
            {
               if(_loc4_ == param1)
               {
                  _loc5_ = true;
      ...
      public function removeChildByID(param1:String) : INode
      {
         ...
         if(_loc2_)
         {
            ...
            while(0 < this.as3isolib_internal::childrenArray.length)
            {
               if(_loc2_ == this.as3isolib_internal::childrenArray[0])
               {
                  this.as3isolib_internal::childrenArray.splice(0,1);
                  break;
               }
               var _loc3_:uint = uint(0 + 1);
            }
            var _loc4_:IsoEvent = new IsoEvent(IsoEvent.CHILD_REMOVED);
