package
{
   ...
   import net.bigpoint.cityrama.view.common.skins.PaperPopupBlueSkin;
   
   public class _net_bigpoint_cityrama_view_common_skins_PaperPopupBlueSkinWatcherSetupUtil implements IWatcherSetupUtil2
   {
      
      public function _net_bigpoint_cityrama_view_common_skins_PaperPopupBlueSkinWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         PaperPopupBlueSkin.watcherSetupUtil = new _net_bigpoint_cityrama_view_common_skins_PaperPopupBlueSkinWatcherSetupUtil();
      }
