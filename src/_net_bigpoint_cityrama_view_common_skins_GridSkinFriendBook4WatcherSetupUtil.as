package
{
   ...
   public class _net_bigpoint_cityrama_view_common_skins_GridSkinFriendBook4WatcherSetupUtil implements IWatcherSetupUtil2
   {
      
      public function _net_bigpoint_cityrama_view_common_skins_GridSkinFriendBook4WatcherSetupUtil()
      {
         super();
      }
      ...
      {
         GridSkinFriendBook4.watcherSetupUtil = new _net_bigpoint_cityrama_view_common_skins_GridSkinFriendBook4WatcherSetupUtil();
      }
