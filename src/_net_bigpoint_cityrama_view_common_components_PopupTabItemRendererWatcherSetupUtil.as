package
{
   ...
   public class _net_bigpoint_cityrama_view_common_components_PopupTabItemRendererWatcherSetupUtil implements IWatcherSetupUtil2
   {
      
      public function _net_bigpoint_cityrama_view_common_components_PopupTabItemRendererWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         PopupTabItemRenderer.watcherSetupUtil = new _net_bigpoint_cityrama_view_common_components_PopupTabItemRendererWatcherSetupUtil();
      }
