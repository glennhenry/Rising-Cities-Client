package
{
   ...
   import net.bigpoint.cityrama.init.preloader.Preloader;
   
   public class _Main_net_bigpoint_cityrama_init_SystemManager extends SystemManager implements IFlexModuleFactory, ISWFContext
   {
      ...
      public function _Main_net_bigpoint_cityrama_init_SystemManager()
      {
         super();
      }
      ...
      override public function info() : Object
      {
         if(!this._info)
         {
            this._info = {
               ...
               ,true,true,"default"),new RSLData("spark_4.6.0.23201.swz","","4bae91dbaef0ceec0fce5505d96ddea865edbfc14dd96e89fb54de12f58432eb","SHA-256",true,true,"default")],[new RSLData("http://fpdownload.adobe.com/pub/swz/flex/4.6.0.23201/sparkskins_4.6.0.23201.swz","http://fpdownload.adobe.com/pub/swz/crossdomain.xml","84d36bdf5e2577bfb0b8ce6a12a8646bb1aadddd24c92e5c12d157d44ad7ce61","SHA-256",true,true,"default"),new RSLData("sparkskins_4.6.0.23201.swz","","84d36bdf5e2577bfb0b8ce6a12a8646bb1aadddd24c92e5c12d157d44ad7ce61","SHA-256",true,true,"default")],[new RSLData("http://fpdownload.adobe.com/pub/swz/flex/4.6.0.23201/mx_4.6.0.23201.swz","http://fpdownload.adobe.com/pub/swz/crossdomain.xml","d888aee0ce49f58a35c32eb138edd00f0d6b9fae68b78d7eb83932c09ef0b6f1","SHA-256",true,true,"default"),new RSLData("mx_4.6.0.23201.swz","","d888aee0ce49f58a35c32eb138edd00f0d6b9fae68b78d7eb83932c09ef0b6f1","SHA-256",true,true,"default")]],
