package
{
   ...
   import net.bigpoint.cityrama.view.common.skins.VScrollTrackButtonSkin;
   
   public class _net_bigpoint_cityrama_view_common_skins_VScrollTrackButtonSkinWatcherSetupUtil implements IWatcherSetupUtil2
   {
      
      public function _net_bigpoint_cityrama_view_common_skins_VScrollTrackButtonSkinWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         VScrollTrackButtonSkin.watcherSetupUtil = new _net_bigpoint_cityrama_view_common_skins_VScrollTrackButtonSkinWatcherSetupUtil();
      }
