package mx.utils
{
   ...
   public class SHA256
   {
      ...
      public static function computeDigest(param1:ByteArray) : String
      {
         ...
         while(_loc7_ < 4)
         {
            _loc4_[_loc8_ - _loc7_] = _loc6_ >> (_loc7_ << 3) & 0xFF;
            _loc7_++;
         }
