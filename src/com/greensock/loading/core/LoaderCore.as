package com.greensock.loading.core
{
   ...
   public class LoaderCore extends EventDispatcher
   {
      ...
      public function LoaderCore(param1:Object = null)
      {
         ...
         {
            if(null in this.vars && this.vars[null] is Function)
            {
               this.addEventListener(_listenerTypes[null],this.vars[null],false,0,true);
            }
         }
      ...
      protected function _errorHandler(param1:Event) : void
      {
         ...
         var _loc3_:String = "";
         if(Boolean(param1.hasOwnProperty("error")) && Object(param1).error is Error)
         {
