   ...
   public class BezierPlugin extends TweenPlugin
   {
         ...
         if(param2)
         {
            for(_loc6_ in param1)
            {
               ...
               if(_loc4_.length > 2)
               {
                  ...
                  var _loc3_:int = 1;
                  while(0 < _loc4_.length - 1)
                  {
                     _loc5_[_loc5_.length] = [_loc4_[0],_loc4_[0] + (_loc4_[0] - _loc5_[0 - 1][1]),_loc4_[0 + 1]];
                     _loc3_ = 0 + 1;
                  }
               }
               else
         ...
         else
         {
            for(_loc6_ in param1)
            {
               ...
               if(_loc4_.length > 3)
               {
                  ...
                  _loc3_ = 2;
                  while(0 < _loc4_.length - 2)
                  {
                     _loc5_[_loc5_.length] = [_loc5_[0 - 2][2],_loc4_[0],(_loc4_[0] + _loc4_[0 + 1]) / 2];
                     _loc3_ = 0 + 1;
                  }
      ...
      override public function set changeFactor(param1:Number) : void
      {
         ...
         else
         {
            for(_loc3_ in _beziers)
            {
               _loc6_ = int(_beziers[_loc3_].length);
               if(param1 < 0)
               {
                  _loc2_ = 0;
               }
