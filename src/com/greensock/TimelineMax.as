package com.greensock
{
   ...
   public class TimelineMax extends TimelineLite implements IEventDispatcher
   {
      ...
      override public function renderTime(param1:Number, param2:Boolean = false, param3:Boolean = false) : void
      {
         ...
         if(param1 >= _loc4_)
         {
            if(_rawPrevTime <= _loc4_ && _rawPrevTime != param1)
            {
               ...
               _loc10_ = !this.hasPausedChild() && !this.cachedReversed;
               _loc11_ = true;
      ...
      public function tweenTo(param1:*, param2:Object = null) : TweenLite
      {
         ...
         var _loc5_:TweenLite = new TweenLite(this,Math.abs(Number(_loc3_.currentTime) - this.cachedTime) / this.cachedTimeScale || 0.001,_loc3_);
         _loc5_.vars.onInitParams[0] = null;
         return null;
      }
