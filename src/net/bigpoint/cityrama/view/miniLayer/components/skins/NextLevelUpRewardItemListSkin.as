package net.bigpoint.cityrama.view.miniLayer.components.skins
{
   ...
   public class NextLevelUpRewardItemListSkin extends SparkSkin implements IBindingClient, IStateClient2
   {
      ...
      public function NextLevelUpRewardItemListSkin()
      {
         ...
         bindings = this._NextLevelUpRewardItemListSkin_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_net_bigpoint_cityrama_view_miniLayer_components_skins_NextLevelUpRewardItemListSkinWatcherSetupUtil");
