package net.bigpoint.cityrama.view.miniLayer.components.skins
{
   ...
   public class CityWheelRewardListSkin extends SparkSkin implements IBindingClient, IStateClient2
   {
      ...
      public function CityWheelRewardListSkin()
      {
         ...
         bindings = this._CityWheelRewardListSkin_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_net_bigpoint_cityrama_view_miniLayer_components_skins_CityWheelRewardListSkinWatcherSetupUtil");
