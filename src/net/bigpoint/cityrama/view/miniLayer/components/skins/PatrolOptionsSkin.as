                                          ...
                                          if(!_loc3_)
                                          {
                                             ...
                                             if(!(_loc3_ && _loc3_))
                                             {
                                                ...
                                                if(_loc4_)
                                                {
                                                   ...
                                                   if(!_loc3_)
                                                   {
                                                      §§pop().§§slot[1] = this._PatrolOptionsSkin_bindingsSetup();
                                                      if(!(_loc3_ && _loc1_))
                                                      {
                                                         §§push(§§newactivation());
                                                         if(_loc4_)
                                                                  ...
                                                                  if(_loc4_ || _loc2_)
                                                                  {
                                                                     ...
                                                                     if(_watcherSetupUtil == null)
                                                                     {
                                                                        if(_loc4_ || _loc1_)
                                                                        {
                                                                           ...
                                                                           {
                                                                              addr0138:
                                                                              §§pop().§§slot[5] = getDefinitionByName("_net_bigpoint_cityrama_view_miniLayer_components_skins_PatrolOptionsSkinWatcherSetupUtil");
                                                                              if(!(_loc3_ && _loc3_))
                                                                              {
                                                                                 addr015f:
                                                                                 §§push(§§newactivation());
