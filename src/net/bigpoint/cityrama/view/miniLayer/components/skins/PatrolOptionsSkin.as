package net.bigpoint.cityrama.view.miniLayer.components.skins
{
   ...
   public class PatrolOptionsSkin extends SparkSkin implements IBindingClient, IStateClient2
   {
      ...
      public function PatrolOptionsSkin()
      {
         var watchers:Array;
         var i:uint;
         ...
         bindings = this._PatrolOptionsSkin_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_net_bigpoint_cityrama_view_miniLayer_components_skins_PatrolOptionsSkinWatcherSetupUtil");
         ...
         {
            return PatrolOptionsSkin[param1];
         },bindings,watchers);
         mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
         mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
         this.mxmlContent = [this._PatrolOptionsSkin_DataGroup1_i(),this._PatrolOptionsSkin_CustomHScrollBar1_i()];
      ...
      {
         PatrolOptionsSkin._watcherSetupUtil = param1;
      }
      ...
      private function handleUpdateComplete(param1:FlexEvent) : void
      {
         ...
         if(!this.hscrollerBar.decrementButton.toolTip)
         {
            this.hscrollerBar.decrementButton.toolTip = ResourceManager.getInstance().getString(String("rcl.tooltips.architecturalBook"),String("rcl.tooltips.architecturalBook.leftArrow"));
         }
         if(!this.hscrollerBar.incrementButton.toolTip)
         {
      ...
      private function _PatrolOptionsSkin_DataGroup1_i() : DataGroup
      {
         ...
         _loc1_.layout = this._PatrolOptionsSkin_HorizontalLayout1_c();
      ...
      private function _PatrolOptionsSkin_HorizontalLayout1_c() : HorizontalLayout
      {
      ...
      private function _PatrolOptionsSkin_CustomHScrollBar1_i() : CustomHScrollBar
      {
      ...
      private function _PatrolOptionsSkin_bindingsSetup() : Array
      {
         var _loc1_:Array = [];
