package net.bigpoint.cityrama.view.miniLayer.ui
{
   ...
   public class CitysquareRewardPreviewMinilayer extends MiniLayerWindow implements IBindingClient
   {
      ...
      public function CitysquareRewardPreviewMinilayer()
      {
         ...
         bindings = this._CitysquareRewardPreviewMinilayer_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_net_bigpoint_cityrama_view_miniLayer_ui_CitysquareRewardPreviewMinilayerWatcherSetupUtil");
      ...
      override protected function commitProperties() : void
      {
         ...
         {
            this._isDirty = false;
            _loc1_ = ResourceManager.getInstance().getString(String("rcl.citysquare.popup.events"),String("rcl.citysquare.popup.events.challenge.header2"));
