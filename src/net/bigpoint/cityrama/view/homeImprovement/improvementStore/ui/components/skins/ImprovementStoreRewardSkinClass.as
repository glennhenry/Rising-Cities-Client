package net.bigpoint.cityrama.view.homeImprovement.improvementStore.ui.components.skins
{
   ...
   public class ImprovementStoreRewardSkinClass extends SparkSkin implements IBindingClient, IStateClient2
   {
      ...
      public function ImprovementStoreRewardSkinClass()
      {
         ...
         bindings = this._ImprovementStoreRewardSkinClass_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_net_bigpoint_cityrama_view_homeImprovement_improvementStore_ui_components_skins_ImprovementStoreRewardSkinClassWatcherSetupUtil");
      ...
      {
         if(this.hscrollerBar && this.hscrollerBar.incrementButton && Boolean(this.hscrollerBar.decrementButton))
         {
            this.hscrollerBar.incrementButton.enabled = this.hscrollerBar.decrementButton.enabled = param1 == "normal";
         }
