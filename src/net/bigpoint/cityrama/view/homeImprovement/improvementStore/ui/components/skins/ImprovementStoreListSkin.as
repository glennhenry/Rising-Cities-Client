package net.bigpoint.cityrama.view.homeImprovement.improvementStore.ui.components.skins
{
   ...
   public class ImprovementStoreListSkin extends SparkSkin implements IBindingClient, IStateClient2
   {
      ...
      public function ImprovementStoreListSkin()
      {
         ...
         bindings = this._ImprovementStoreListSkin_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_net_bigpoint_cityrama_view_homeImprovement_improvementStore_ui_components_skins_ImprovementStoreListSkinWatcherSetupUtil");
