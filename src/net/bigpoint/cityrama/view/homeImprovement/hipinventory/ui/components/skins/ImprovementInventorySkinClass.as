package net.bigpoint.cityrama.view.homeImprovement.hipinventory.ui.components.skins
{
   ...
   public class ImprovementInventorySkinClass extends SparkSkin implements IBindingClient, IStateClient2
   {
      ...
      public function ImprovementInventorySkinClass()
      {
         ...
         bindings = this._ImprovementInventorySkinClass_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_net_bigpoint_cityrama_view_homeImprovement_hipinventory_ui_components_skins_ImprovementInventorySkinClassWatcherSetupUtil");
