package net.bigpoint.cityrama.view.citysquare.ui.components.skins
{
   ...
   public class EventSelectionListSkin extends SparkSkin implements IBindingClient, IStateClient2
   {
      ...
      public function EventSelectionListSkin()
      {
         ...
         bindings = this._EventSelectionListSkin_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_net_bigpoint_cityrama_view_citysquare_ui_components_skins_EventSelectionListSkinWatcherSetupUtil");
      ...
      private function handleUpdateComplete(param1:FlexEvent) : void
      {
         ...
         {
            this.hscrollerBar.decrementButton.toolTip = LocaUtils.getString(String("rcl.tooltips.architecturalBook"),String("rcl.tooltips.architecturalBook.leftArrow"));
         }
