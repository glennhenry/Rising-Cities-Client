package net.bigpoint.cityrama.view.citysquare.ui.components.skins
{
   ...
   public class VerticalScrollbarList extends SparkSkin implements IBindingClient, IStateClient2
   {
      ...
      public function VerticalScrollbarList()
      {
         ...
         bindings = this._VerticalScrollbarList_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_net_bigpoint_cityrama_view_citysquare_ui_components_skins_VerticalScrollbarListWatcherSetupUtil");
