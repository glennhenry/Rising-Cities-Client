package net.bigpoint.cityrama.view.common.skins
{
   ...
   public class GridSkin extends SparkSkin implements IBindingClient, IStateClient2
   {
      ...
      public function GridSkin()
      {
         ...
         bindings = this._GridSkin_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_net_bigpoint_cityrama_view_common_skins_GridSkinWatcherSetupUtil");
      ...
      private function _GridSkin_Animate1_i() : Animate
      {
         ...
         _loc1_.duration = 500;
         _loc1_.motionPaths = new <MotionPath>[this._GridSkin_SimpleMotionPath1_i()];
