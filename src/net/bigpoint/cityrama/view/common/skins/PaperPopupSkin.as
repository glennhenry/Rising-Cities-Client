package net.bigpoint.cityrama.view.common.skins
{
   ...
   public class PaperPopupSkin extends SparkSkin implements IBindingClient, IStateClient2
   {
      ...
      public function PaperPopupSkin()
      {
         ...
         bindings = this._PaperPopupSkin_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_net_bigpoint_cityrama_view_common_skins_PaperPopupSkinWatcherSetupUtil");
