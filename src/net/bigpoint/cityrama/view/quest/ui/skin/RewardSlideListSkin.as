package net.bigpoint.cityrama.view.quest.ui.skin
{
   ...
   public class RewardSlideListSkin extends SparkSkin implements IBindingClient, IStateClient2
   {
      ...
      public function RewardSlideListSkin()
      {
         ...
         bindings = this._RewardSlideListSkin_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_net_bigpoint_cityrama_view_quest_ui_skin_RewardSlideListSkinWatcherSetupUtil");
