package net.bigpoint.cityrama.view.quest.ui.skin
{
   ...
   public class QuestLayerRewardSkin extends SparkSkin implements IBindingClient, IStateClient2
   {
      ...
      public function QuestLayerRewardSkin()
      {
         ...
         bindings = this._QuestLayerRewardSkin_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_net_bigpoint_cityrama_view_quest_ui_skin_QuestLayerRewardSkinWatcherSetupUtil");
