package net.bigpoint.cityrama.view.mainMenu.ui.skins
{
   ...
   public class QuadToggleButtonSkin extends SparkSkin implements IBindingClient, IStateClient2
   {
      ...
      public function QuadToggleButtonSkin()
      {
         ...
         bindings = this._QuadToggleButtonSkin_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_net_bigpoint_cityrama_view_mainMenu_ui_skins_QuadToggleButtonSkinWatcherSetupUtil");
         ...
         states = [new State({
            ...
            "overrides":[this._QuadToggleButtonSkin_SetProperty4 = SetProperty(new SetProperty().initializeFromObject({
               "isBaseValueDataBound":true,
               "target":"_QuadToggleButtonSkin_BriskImageDynaLib4",
               "name":"dynaBmpSourceName",
               "value":undefined
      ...
      private function _QuadToggleButtonSkin_bindingsSetup() : Array
      {
         ...
         result[21] = new Binding(this,null,null,"_QuadToggleButtonSkin_BriskImageDynaLib5.mask","maskImage");
