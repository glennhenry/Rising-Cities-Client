package net.bigpoint.cityrama.view.friendBook.ui.components
{
   ...
   public class FriendTabItemRenderer extends ItemRenderer implements IBindingClient, IStateClient2
   {
      ...
      public function FriendTabItemRenderer()
      {
         ...
         bindings = this._FriendTabItemRenderer_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_net_bigpoint_cityrama_view_friendBook_ui_components_FriendTabItemRendererWatcherSetupUtil");
