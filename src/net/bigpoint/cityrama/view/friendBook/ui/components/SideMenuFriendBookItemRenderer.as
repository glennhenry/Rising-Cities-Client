package net.bigpoint.cityrama.view.friendBook.ui.components
{
   ...
   public class SideMenuFriendBookItemRenderer extends ItemRenderer implements IBindingClient, IStateClient2
   {
      ...
      public function SideMenuFriendBookItemRenderer()
      {
         ...
         bindings = this._SideMenuFriendBookItemRenderer_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_net_bigpoint_cityrama_view_friendBook_ui_components_SideMenuFriendBookItemRendererWatcherSetupUtil");
      ...
      private function _SideMenuFriendBookItemRenderer_Animate1_i() : Animate
      {
         ...
         _loc1_.duration = 200;
         _loc1_.motionPaths = new <MotionPath>[this._SideMenuFriendBookItemRenderer_SimpleMotionPath1_c()];
