package net.bigpoint.cityrama.view.residentialBook.ui.skins
{
   ...
   public class NeedsListSkin extends SparkSkin implements IBindingClient, IStateClient2
   {
      ...
      public function NeedsListSkin()
      {
         ...
         bindings = this._NeedsListSkin_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_net_bigpoint_cityrama_view_residentialBook_ui_skins_NeedsListSkinWatcherSetupUtil");
