package net.bigpoint.cityrama.view.residentialBook.ui.skins
{
   ...
   public class ImprovementInventoryLayerSkin extends SparkSkin implements IBindingClient, IStateClient2
   {
      ...
      public function ImprovementInventoryLayerSkin()
      {
         ...
         bindings = this._ImprovementInventoryLayerSkin_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_net_bigpoint_cityrama_view_residentialBook_ui_skins_ImprovementInventoryLayerSkinWatcherSetupUtil");
