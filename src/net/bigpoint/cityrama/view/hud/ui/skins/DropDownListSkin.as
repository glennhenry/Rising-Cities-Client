package net.bigpoint.cityrama.view.hud.ui.skins
{
   ...
   public class DropDownListSkin extends SparkSkin implements IBindingClient, IStateClient2
   {
      ...
      public function DropDownListSkin()
      {
         ...
         bindings = this._DropDownListSkin_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_net_bigpoint_cityrama_view_hud_ui_skins_DropDownListSkinWatcherSetupUtil");
         ...
         _DropDownListSkin_PopUpAnchor1_factory = new DeferredInstanceFromFunction(this._DropDownListSkin_PopUpAnchor1_i,this._DropDownListSkin_PopUpAnchor1_r);
         states = [new State({
            "name":"normal",
