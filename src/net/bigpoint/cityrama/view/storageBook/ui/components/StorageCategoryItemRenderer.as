package net.bigpoint.cityrama.view.storageBook.ui.components
{
   ...
   public class StorageCategoryItemRenderer extends ItemRenderer implements IBindingClient, IStateClient2
   {
      ...
      public function StorageCategoryItemRenderer()
      {
         ...
         bindings = this._StorageCategoryItemRenderer_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_net_bigpoint_cityrama_view_storageBook_ui_components_StorageCategoryItemRendererWatcherSetupUtil");
