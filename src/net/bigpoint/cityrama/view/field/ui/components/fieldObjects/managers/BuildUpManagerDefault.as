package net.bigpoint.cityrama.view.field.ui.components.fieldObjects.managers
{
   ...
   public class BuildUpManagerDefault implements IBuildUpManager
   {
      ...
      private function isDirty() : void
      {
         ...
         if(this._data.useConstructionAsset)
         {
      ...
      private function get targetFrame() : String
      {
         ...
         for each(_loc1_ in this._data.configPlayfieldItemVo.tags)
         {
            if(_loc1_ == ServerRestrictionConstants.SEA_WHITELIST)
            {
               return "cs_SEA_" + this._data.currentBuildAsset + "_" + this._data.configPlayfieldItemVo.sizeX + "_" + this._data.configPlayfieldItemVo.sizeY;
            }
            if(_loc1_ == ServerRestrictionConstants.COAST_WHITELIST || _loc1_ == ServerRestrictionConstants.FISHINGGROUND_WHITELIST)
            {
               return "cs_COAST_" + this._data.currentBuildAsset + "_" + this._data.configPlayfieldItemVo.sizeX + "_" + this._data.configPlayfieldItemVo.sizeY;
            }
         }
         return "cs_" + this._data.currentBuildAsset + "_" + this._data.configPlayfieldItemVo.sizeX + "_" + this._data.configPlayfieldItemVo.sizeY;
      }
