package net.bigpoint.cityrama.view.residentSelection.ui.skins
{
   ...
   public class ResidentListSkin extends SparkSkin implements IBindingClient, IStateClient2
   {
      ...
      public function ResidentListSkin()
      {
         ...
         bindings = this._ResidentListSkin_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_net_bigpoint_cityrama_view_residentSelection_ui_skins_ResidentListSkinWatcherSetupUtil");
      ...
      private function checkScroll(param1:FlexEvent = null) : void
      {
         ...
         if(this.dataGroup.numElements > 3)
         {
            if(_loc3_)
            {
               this.scrollLeftButton.visible = this.scrollLeftButton.enabled = !this.dataGroup.scrollRect.containsRect(_loc3_.getBounds(this.dataGroup));
            }
            if(_loc4_)
            {
               this.scrollRightButton.visible = this.scrollRightButton.enabled = !this.dataGroup.scrollRect.containsRect(_loc4_.getBounds(this.dataGroup));
            }
            else
            {
      ...
      private function _ResidentListSkin_Animate1_i() : Animate
      {
         ...
         _loc1_.duration = 500;
         _loc1_.motionPaths = new <MotionPath>[this._ResidentListSkin_SimpleMotionPath1_i()];
