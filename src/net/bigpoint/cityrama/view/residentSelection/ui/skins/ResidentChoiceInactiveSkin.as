package net.bigpoint.cityrama.view.residentSelection.ui.skins
{
   ...
   public class ResidentChoiceInactiveSkin extends SparkSkin implements IBindingClient, IStateClient2
   {
      ...
      public function ResidentChoiceInactiveSkin()
      {
         ...
         bindings = this._ResidentChoiceInactiveSkin_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_net_bigpoint_cityrama_view_residentSelection_ui_skins_ResidentChoiceInactiveSkinWatcherSetupUtil");
