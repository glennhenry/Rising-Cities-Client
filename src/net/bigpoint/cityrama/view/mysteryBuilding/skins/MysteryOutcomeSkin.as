package net.bigpoint.cityrama.view.mysteryBuilding.skins
{
   ...
   public class MysteryOutcomeSkin extends SparkSkin implements IBindingClient, IStateClient2
   {
      ...
      public function MysteryOutcomeSkin()
      {
         ...
         bindings = this._MysteryOutcomeSkin_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_net_bigpoint_cityrama_view_mysteryBuilding_skins_MysteryOutcomeSkinWatcherSetupUtil");
      ...
      private function handleUpdateComplete(param1:FlexEvent) : void
      {
         ...
         {
            this.hscrollerBar.decrementButton.toolTip = LocaUtils.getString("rcl.tooltips.architecturalBook","rcl.tooltips.architecturalBook.leftArrow");
         }
