package net.bigpoint.cityrama.view.emergencyBook.ui.skins
{
   ...
   public class EmergencySlotListSkin extends SparkSkin implements IBindingClient, IStateClient2
   {
      ...
      public function EmergencySlotListSkin()
      {
         ...
         bindings = this._EmergencySlotListSkin_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_net_bigpoint_cityrama_view_emergencyBook_ui_skins_EmergencySlotListSkinWatcherSetupUtil");
