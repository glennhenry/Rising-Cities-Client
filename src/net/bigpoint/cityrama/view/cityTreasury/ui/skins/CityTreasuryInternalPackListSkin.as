package net.bigpoint.cityrama.view.cityTreasury.ui.skins
{
   ...
   public class CityTreasuryInternalPackListSkin extends SparkSkin implements IBindingClient, IStateClient2
   {
      ...
      public function CityTreasuryInternalPackListSkin()
      {
         ...
         bindings = this._CityTreasuryInternalPackListSkin_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_net_bigpoint_cityrama_view_cityTreasury_ui_skins_CityTreasuryInternalPackListSkinWatcherSetupUtil");
