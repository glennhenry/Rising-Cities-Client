package net.bigpoint.cityrama.view.cityTreasury.ui.skins
{
   ...
   public class CityTreasuryExternalPackListSkin extends SparkSkin implements IBindingClient, IStateClient2
   {
      ...
      public function CityTreasuryExternalPackListSkin()
      {
         ...
         bindings = this._CityTreasuryExternalPackListSkin_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_net_bigpoint_cityrama_view_cityTreasury_ui_skins_CityTreasuryExternalPackListSkinWatcherSetupUtil");
