   ...
   public class OutputItemRendered extends ItemRenderer
   {
      ...
      override public function set data(param1:Object) : void
      {
         ...
         if(param1 is SimpleItemVo)
         {
            ...
            _loc3_ = LocaUtils.getThousendSeperatedNumber(Math.abs(_loc2_.maxAmount));
            _loc4_ = LocaUtils.getThousendSeperatedNumber(Math.abs(_loc2_.amount));
            this.effectAmount.text = _loc4_ + "/" + _loc3_;
