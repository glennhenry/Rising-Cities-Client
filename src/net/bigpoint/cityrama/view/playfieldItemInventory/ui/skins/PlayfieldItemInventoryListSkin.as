package net.bigpoint.cityrama.view.playfieldItemInventory.ui.skins
{
   ...
   public class PlayfieldItemInventoryListSkin extends SparkSkin implements IBindingClient, IStateClient2
   {
      ...
      public function PlayfieldItemInventoryListSkin()
      {
         ...
         bindings = this._PlayfieldItemInventoryListSkin_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_net_bigpoint_cityrama_view_playfieldItemInventory_ui_skins_PlayfieldItemInventoryListSkinWatcherSetupUtil");
      ...
      private function handleUpdateComplete(param1:FlexEvent) : void
      {
         ...
         if(!this.scrollBar.decrementButton.toolTip)
         {
            this.scrollBar.decrementButton.toolTip = LocaUtils.getString("rcl.tooltips.architecturalBook","rcl.tooltips.architecturalBook.leftArrow");
         }
         if(!this.scrollBar.incrementButton.toolTip)
         {
