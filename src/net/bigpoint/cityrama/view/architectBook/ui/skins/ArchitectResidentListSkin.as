package net.bigpoint.cityrama.view.architectBook.ui.skins
{
   ...
   public class ArchitectResidentListSkin extends SparkSkin implements IBindingClient, IStateClient2
   {
      ...
      public function ArchitectResidentListSkin()
      {
         ...
         bindings = this._ArchitectResidentListSkin_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_net_bigpoint_cityrama_view_architectBook_ui_skins_ArchitectResidentListSkinWatcherSetupUtil");
      ...
      private function _ArchitectResidentListSkin_Animate1_i() : Animate
      {
         ...
         _loc1_.duration = 500;
         _loc1_.motionPaths = new <MotionPath>[this._ArchitectResidentListSkin_SimpleMotionPath1_i()];
