package net.bigpoint.cityrama.view.architectBook.ui.skins
{
   ...
   public class GridItemGoodSkin extends SparkSkin implements IStateClient2
   {
      ...
      protected function handleCreationComplete(param1:FlexEvent) : void
      {
         ...
         if(this.hostComponent.itemIndex > 1)
         {
            if(this.hostComponent.itemIndex % 3 == 0)
            {
               this.backgroundPrint.dynaBmpSourceName = "ressource_cardboard3_small";
            }
            else if(this.hostComponent.itemIndex % 2 == 0)
            {
               this.backgroundPrint.dynaBmpSourceName = "ressource_cardboard2_small";
            }
         }
      }
