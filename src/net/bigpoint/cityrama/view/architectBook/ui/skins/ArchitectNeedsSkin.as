package net.bigpoint.cityrama.view.architectBook.ui.skins
{
   ...
   public class ArchitectNeedsSkin extends SparkSkin implements IBindingClient, IStateClient2
   {
      ...
      public function ArchitectNeedsSkin()
      {
         ...
         bindings = this._ArchitectNeedsSkin_bindingsSetup();
         watchers = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_net_bigpoint_cityrama_view_architectBook_ui_skins_ArchitectNeedsSkinWatcherSetupUtil");
      ...
      private function checkScroll(param1:FlexEvent = null) : void
      {
         ...
         if(_loc2_.length > 0)
         {
            ...
            {
               this.leftButton.visible = !this.dataGroup.scrollRect.containsRect(_loc4_);
